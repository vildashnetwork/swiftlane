...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-heading",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:scale-105 rounded-lg shadow-button",
        ...
        hero: "bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:scale-105 shadow-button hover:shadow-xl rounded-full",
        cta: "bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:scale-105 shadow-button hover:shadow-xl rounded-full",
        white: "bg-background text-foreground hover:bg-muted border border-border rounded-lg",
      },
      size: {
